...

{
  ...
  c1.Print( "s8-600.ps[", "Portrait" ); // [ opens file
  ...
  TFile * fdata = TFile::Open( "/home/pitzl/eudaq/tele-scope/scopedf34430.root" );
  colpvsy->SetStats(0);
  colpvsy->SetTitle( "8 #upoint10^{15 }n/cm^{2} edge-on 600 V" );
  ...
  //TFile * fsim = TFile::Open( "edg3_px50_F8_mode0_e2_h2_V600.root" ); // mdy 5.3

  //TFile * fsim = TFile::Open( "edg3_px50_F8_mode1_e3_h3_V600.root" ); // mdy 3.7

  TFile * fsim = TFile::Open( "edg3_px50_F8_dlt10_e4_h4_V600.root" ); // mdy 3.45
  //TFile * fsim = TFile::Open( "edg3_px50_F8_dlt11_e4_h4_V600.root" ); // mdy 2.71

//TFile * fsim = TFile::Open( "edg15_px25_F8_dlt11_e2_h2_V600.root" ); // mdy 1.59
  ...
  c1.Print( "s8-600.ps]" ); // ] closes file
  int ierr;
  ierr = system( "ps2pdf s8-600.ps" );
  ierr = system( "rm -f  s8-600.ps" );
  cout << "evince s8-600.pdf" << endl;
