...

{
  ...
  c1.Print( "s6-500.ps[", "Portrait" ); // [ opens file
  ...
  TFile * fdata = TFile::Open( "/home/pitzl/eudaq/tele-scope/scoped33583.root" ); // 174
  colpvsy->SetStats(0);
  colpvsy->SetTitle( "6.6 #upoint10^{15 }p/cm^{2} edge-on 500 V" );
  ...
  TFile * fsim = TFile::Open( "edg9_px50_F6_dlt9_e7_h28_V500.root" ); // mob3 mdy 2.54

  //TFile * fsim = TFile::Open( "edg9_px50_F6_dlt9_e7_h21_V500.root" ); // mob4 mdy 2.05
  //TFile * fsim = TFile::Open( "edg9_px50_F6_dlt9_e11_h28_V500.root" ); // mob4 mdy 2.77
  ...
  c1.Print( "s6-500.ps]" ); // ] closes file
  int ierr;
  ierr = system( "ps2pdf s6-500.ps" );
  ierr = system( "rm -f  s6-500.ps" );
  cout << "evince s6-500.pdf" << endl;
