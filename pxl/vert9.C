...
*/
{
  ...
  det->SetUpPixel( 3, 0.5*px, 1.5*py, 0.45*px, 0.45*py, 0.5,     1 ); // Grnd
  det->SetUpPixel( 4, 1.5*px, 1.5*py, 0.45*px, 0.45*py, 0.5, 16385 ); // collecting electrode at Grnd
  det->SetUpPixel( 5, 2.5*px, 1.5*py, 0.45*px, 0.45*py, 0.5,     1 ); // Grnd
  ...
  TFile * fn = new
    TFile( Form( "vert9_dlt%d_V%d.root",
  ...
  TH1F * field = det->Draw1D( "EZxz1", 1.5*py, 2, 1.5*px );
  ...
  TH1F * wpot = det->Draw1D( "WPxz1", 1.5*py, 2, 1.5*px );
  wpot->Draw();  
  cWP1.Update();
