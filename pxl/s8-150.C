...

{
  ...
  c1.Print( "s8-150.ps[", "Portrait" ); // [ opens file
  ...
  TFile * fdata = TFile::Open( "/home/pitzl/eudaq/tele-scope/scopedf34436.root" );
  colpvsy->SetStats(0);
  colpvsy->SetTitle( "8 #upoint10^{15 }n/cm^{2} edge-on 150 V" );
  ...
  //TFile * fsim = TFile::Open( "edg3_px50_F8_lam10_e4_h4_V150.root" );
  TFile * fsim = TFile::Open( "edg3_px50_F8_dlt11_e4_h4_V150.root" ); // mdy 1.28

  //TFile * fsim = TFile::Open( "edg15_px25_F8_dlt11_e4_h3_V150.root" ); // mdy 1.10
  ...
  c1.Print( "s8-150.ps]" ); // ] closes file
  int ierr;
  ierr = system( "ps2pdf s8-150.ps" );
  ierr = system( "rm -f  s8-150.ps" );
  cout << "evince s8-150.pdf" << endl;
