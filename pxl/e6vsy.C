...

{
  ...
  TLegend * lgnd = new TLegend( 0.5, 0.3, 0.7, 0.9 );
  ...
  evsy->SetStats(0);
  evsy->SetLineColor(91); // gold
  evsy->Draw( "samel" );
  lgnd->AddEntry( evsy, " 450 V", "l" );
