...
void edg15F8( double Vbias = 300 ) */
{
  ...
  double dlt = 0.0008 * Vbias/250; // [cm] 
  double N0 = 2566 * 250/Vbias; // [1/um^3] adjust at 250V, scaled 1/dlt^2 at fixed Vbias
  ...
  double taue = 16/F; // [ns] at 250V: mdy 2.47

  // hole trapping: induces anti-charge

  //double tauh = 9/F; // [ns] at 250 V: mdy 2.47
  double tauh = 8/F; // [ns] at 250 V: mdy 2.45
  //double tauh = 7/F; // [ns] at 250 V: mdy 2.51
