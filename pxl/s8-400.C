...

{
  ...
  c1.Print( "s8-400.ps[", "Portrait" ); // [ opens file
  ...
  TFile * fdata = TFile::Open( "/home/pitzl/eudaq/tele-scope/scopedf34432.root" );
  colpvsy->SetStats(0);
  colpvsy->SetTitle( "8 #upoint10^{15 }n/cm^{2} edge-on 400 V" );
  ...
  colpvsy->Draw();
  lgnd->AddEntry( colpvsy, " Data 400 V ", "l" );
  ...
  //TFile * fsim = TFile::Open( "oedg3_px50_F8_mode1_e3_h3_V400.root" );

  //TFile * fsim = TFile::Open( "edg3_px50_F8_lam10_e4_h4_V400.root" ); // mean dy 1.87
  //TFile * fsim = TFile::Open( "edg3_px50_F8_dlt11_e4_h4_V400.root" ); // mdy 4.48 too wide
  TFile * fsim = TFile::Open( "edg3_px50_F8_dlt10_e4_h4_V400.root" ); // mdy 2.24

  //TFile * fsim = TFile::Open( "edg15_px25_F8_dlt10_e3p4_h2p8_V400.root" ); // mean dy 1.99

  //TFile * fsim = TFile::Open( "edg15_px25_F8_dlt11_e2_h1_V400.root" ); // mdy 1.41
  ...
  c1.Print( "s8-400.ps]" ); // ] closes file
  int ierr;
  ierr = system( "ps2pdf s8-400.ps" );
  ierr = system( "rm -f  s8-400.ps" );
  cout << "evince s8-400.pdf" << endl;
