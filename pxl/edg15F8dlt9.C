...
void edg15F8( double Vbias = 300 ) */
{
  ...
  //double N0 = 2006 * 250/Vbias; // [1/um^3] adjust at 250V, scaled 1/dlt^2 at fixed Vbias
  double N0 = 2010 * 250/Vbias; // [1/um^3] adjust at 250V, scaled 1/dlt^2 at fixed Vbias
  ...
  double taue = 7.4/F; // [ns] at 250V: mdy 1.59 with N0 2010

  //double taue = 6.6/F; // [ns] at 250V: mdy 1.80 with N0 2006
  //double taue = 6.4/F; // [ns] at 250V: mdy 1.92

  if( Vbias > 470 )
    taue = 4.2/F; // [ns] at 500V: mdy 2.04

  // hole trapping: induces anti-charge

  double tauh = 7.4/F; // [ns] at 250 V: mdy 1.59 with N0 2010

  //double tauh = 4.6/F; // [ns] at 250 V: mdy 1.80 with N0 2006
  //double tauh = 4.4/F; // [ns] at 250 V: mdy 1.83

  if( Vbias > 470 )
    tauh = 4.6/F; // [ns] at 500V: mdy 2.04
  ...
  f3->SetParameter( 0, dj*pow( Vbias/500, 3 ) ); // [1/um^3] double junction
